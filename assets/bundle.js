...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FlexContext$FlexBox = __webpack_require__(2);
	  ...
	  _createClass(Container, [{
	    ...
	    value: function render() {
	      return _React2['default'].createElement(
	        'g',
	        null,
	        _React2['default'].createElement('rect', { fill: this.props.color,
	          x: '0',
	          y: '0',
	...
	var Backdrop = _FlexContext$FlexBox.FlexBox(Container, {
	  flexDirection: 'row',
	  flex: 1,
	  padding: 40,
	  flexWrap: 'wrap',
	...
	var Square = _FlexContext$FlexBox.FlexBox(Container, {
	  height: 40,
	  width: 40
	});
	    ...
	    value: function render() {
	      ...
	      return _React2['default'].createElement(
	        ...
	        _React2['default'].createElement(
	          _FlexContext$FlexBox.FlexContext,
	          { layout: containerStyle },
	          _React2['default'].createElement(
	            Backdrop,
	            { color: '#CE6E09' },
	            board.map(function (id) {
	              return _React2['default'].createElement(Square, {
	                key: id,
	                color: Math.floor(id / 8) % 2 ? id % 2 ? '#470300' : '#F6B968' : id % 2 ? '#F6B968' : '#470300'
	              });
	            })
	          )
	        )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _computeLayout = __webpack_require__(5);
	...
	function setLayout(style) {
	  var layout = arguments[1] === undefined ? styles : arguments[1];
	  var path = arguments[2] === undefined ? [] : arguments[2];

	  if (layout.style === undefined) {
	    layout.style = style;
	  } else {
	    var childLayout = { style: style, children: [] };
	  ...
	  return {
	    path: path.slice(),
	    setLayout: (function (_setLayout) {
	      function setLayout(_x) {
	        return _setLayout.apply(this, arguments);
	      }

	      setLayout.toString = function () {
	        return _setLayout.toString();
	      };
	...
	var FlexContext = (function (_Component) {
	  function FlexContext(props, context) {
	    ...
	    var _setLayout2 = setLayout(layout);

	    var layoutFunc = _setLayout2.setLayout;
	  ...
	  _createClass(FlexContext, [{
	    ...
	    value: function componentDidMount() {
	      var flexStyles = _computeLayout2['default'](styles);
	    ...
	    value: {
	      setLayout: _React2['default'].PropTypes.func.isRequired,
	...
	var FlexBox = function FlexBox(Composed) {
	  var style = arguments[1] === undefined ? {} : arguments[1];
	  return (function (_Component2) {
	    var _class = function (props, context) {
	      ...
	      var _context$setLayout = context.setLayout(style);

	      var layoutFunc = _context$setLayout.setLayout;
	      var path = _context$setLayout.path;
	    ...
	    _createClass(_class, [{
	      ...
	      value: function render() {
	        ...
	        return _React2['default'].createElement(
	          ...
	          _React2['default'].createElement(Composed, _extends({}, this.props, { layout: this.state.layout }))
	        );
	      }
	    }], [{
	      key: 'displayName',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	   ...
	   */
	  var stackHasTagInSpecificScope = function stackHasTagInSpecificScope(stack, tag, scope) {
	  ...
	  var stackHasTagInScope = function stackHasTagInScope(stack, tag) {
	    return stackHasTagInSpecificScope(stack, tag, inScopeTags);
	  };

	  // https://html.spec.whatwg.org/multipage/syntax.html#has-an-element-in-button-scope
	  var buttonScopeTags = inScopeTags.concat(["button"]);
	  var stackHasTagInButtonScope = function stackHasTagInButtonScope(stack, tag) {
	    return stackHasTagInSpecificScope(stack, tag, buttonScopeTags);
	  };

	  // See rules for 'li', 'dd', 'dt' start tags in
	  // https://html.spec.whatwg.org/multipage/syntax.html#parsing-main-inbody
	  var listItemTagAllowed = function listItemTagAllowed(tags, stack) {
	    // tags is ['li'] or ['dd, 'dt']
	    for (var i = stack.length - 1; i >= 0; i--) {
	   ...
	   */
	  var isTagValidInContext = function isTagValidInContext(tag, openTagStack) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LinkedValueUtils = {
	   ...
	   */
	  getOnChange: function getOnChange(inputProps) {
	    if (inputProps.valueLink) {
	      _assertValueLink(inputProps);
